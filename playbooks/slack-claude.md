...
- 2026-07-22 — Varun is connecting the **Slack MCP to laptop Claude** — would give laptop sessions direct Slack read, shifting morning sweeps laptop-side (proper dedupe, thread reads) with Slack Claude as in-workspace contributor. Update this playbook + `playbooks/morning-routine.md` once live.
