...
- 2026-07-24 — **AI-1474 keyword GPC reclassification: release + 2.2M run** — multi-step checklist at `tasks/ai-1474-release.md`. ⏳ claimed 2026-07-30 ai1474-release-resume: awaiting Sunil's eval-ID/cache decision; 762-row retry verified and waiting for AI-1538 to release the shared classic cluster. Databricks auth restored; dev HPA downshift merged. Tribikram scope resolved: revert AI-1361 PR #44; combined branch validated locally.
