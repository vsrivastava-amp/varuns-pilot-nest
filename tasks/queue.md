...
- 2026-07-24 — **AI-1474 keyword GPC reclassification: release + 2.2M run** — multi-step checklist at `tasks/ai-1474-release.md` (winner picked: gemini-3-6-flash eval 6; release trim → PR → deploy → full run → gold swap). ⏳ claimed 2026-07-24 ai1474 (active session).
