...
- 2026-07-29 ~12:02 ET — more Varun-directed Jira writes: AI-1589 description revised (measure AND improve; blocked-by note) + formal "Blocks" link AI-1556 -> AI-1589 (AI-1556 confirmed as Bhupesh's relevance-eval dataset ticket); AI-1474 closing comment 171249 posted from review/2026-07-29-ai1474-closing-jira.txt (draft deleted). AI-1474 left In Review per Varun's silence on transition; civ_config row sync still open (eval-id 4/6 collision).
